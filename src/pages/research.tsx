...
<p><b>Lee, H.Y. </b>(2010-2011). Principal Investigator. $51,000. Research and Program Evaluation for Tobacco Cessation in American Indians. Funded by the American Cancer Society and the University of Minnesota Institute for Health Informatics.</p>
  ...
  <div className="ua_component_wrapper ua_custom-class">
    <details className="ua_accordion">
      <summary>International Projects</summary>
      <div className="details-content">
...
<p>Lee, H.Y. (2015-2019). Co-Investigator. Frailty cohort construction and development of frailty 
...
<p>Lee, H.Y. (2017-2018). Co-Investigator. Developing the Technology of Personalized Mobility 
    Chain for Elderly. 50,000,000 won (equivalent to $50,000). Funded by the Ministry of 
    Health and Welfare. (Written in Korean)</p>

<p>Lee, H.Y. (2015-2018). Co-Investigator. 300,000,000 Won (equivalent to $300,000).
...
<p>Lee, H.Y. (2016-2017). Co-Investigator. 90,000,000 Won (equivalent to $90,000). Developing 
...
<p>Lee, H.Y. (2013-2016). Co-Investigator. 300,000,000 Won (equivalent to $300,000).
    Health literacy in Korea: Differences across age and gender groups (PI: Soondul 
    Chung, Ph.D., Ehwa Women’s University School of Social Work). Funded by the 
    National Research Foundation of Korea (NFR-2013-S1A3A2055071). (Written in 
    Korean)</p>

<p>Lee, H.Y. (2013-2014). Co-Investigator. 20,000,000 Won (equivalent to $20,000). Health 
...
<p>Lee, H.Y. (2013-2014). Co-Investigator. 50,000,000 Won (equivalent to $50,000). Exploratory 
...
<p>Lee, H.Y. (2012-2013). Co-Investigator. 20,000,000 Won (equivalent to $20,000). Health 
...
<p>Lee, H.Y. (2011-2012). $1500. 2011 Trek/Transform one year long technology training for 
    teaching, College of Education and Human Development, University of Minnesota.</p>

<p>Lee, H.Y. (Summer, 2010). $3,000. Travel grant to Hong Kong, China, to attend the 2010 Joint 
...
<p>Lee, H.Y. (Summer, 2009). $4,000. Annual conference support. A partnership approach to
...
<p>Lee, H.Y. (Summer, 2007). $3,000. Travel grant to Seoul, South Korea, for the purpose of 
